...
const Profile = () => {
  ...
  if (!user) return <div className="min-h-screen bg-black flex items-center justify-center text-slate-400">Loading profile...</div>;

  return (
    <div className="min-h-screen bg-black text-white font-sans relative" style={{ paddingTop: "80px" }}>
      ...
      {/* --- MAIN CONTENT AREA --- */}
      <div className="mx-6 lg:mx-10 pb-10 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="glass-panel p-5 rounded-xl flex flex-col justify-between h-32 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-blue-600 rounded-lg text-white"><TrendingUp size={18} /></div>
          ...
          <div className="glass-panel p-5 rounded-xl flex flex-col justify-between h-32 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-orange-600 rounded-lg text-white"><AlertCircle size={18} /></div>
          ...
          <div className="glass-panel p-5 rounded-xl flex flex-col justify-between h-32 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-green-600 rounded-lg text-white"><Clock size={18} /></div>
          ...
          <div className="glass-panel p-5 rounded-xl flex flex-col justify-between h-32 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-purple-600 rounded-lg text-white"><Target size={18} /></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-panel rounded-xl p-8 flex flex-col h-full">
          ...
          <div className="glass-panel rounded-xl overflow-hidden flex flex-col h-full">
            <div className="p-6 border-b border-slate-700/50 flex justify-between items-center bg-transparent">
