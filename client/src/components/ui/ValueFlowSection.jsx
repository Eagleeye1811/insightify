    ...
    <section className="relative bg-black py-28 text-white overflow-hidden">
      ...
      >
        ...
        <p className="mt-6 text-white/70 text-lg">
          Intelligent tools that simplify decisions, uncover opportunities,
          and give your business an unfair advantage.
        </p>
      </motion.div>
      ...
      <div className="relative max-w-5xl mx-auto px-4">
        ...
        <div className="absolute left-1/2 top-0 h-full w-[2px] -translate-x-1/2 bg-gradient-to-b from-violet-500 via-purple-500 to-indigo-500 opacity-40" />
        ...
        {features.map((_, index) => (
          <motion.div
            ...
            style={{ top: `${(index * 100) / (features.length - 1)}%` }}
