...
const steps = [
  {
    ...
    desc: "Drop your Google Play or App Store link. We instantly start analyzing user reviews.",
    icon: "�",
  },
  {
    step: "02",
    title: "Sign In Securely",
    desc: "Create your account in seconds. Your data stays encrypted and private.",
    icon: "🛡️",
  },
  {
    step: "03",
        ...
        <div className="grid grid-cols-3 gap-8 relative">
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              >
                {/* Glowing background */}
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-violet-600 rounded-full blur-xl opacity-60 animate-pulse"></div>
                <div className="relative w-16 h-16 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg z-10">
                  {item.step}
                </div>
              </motion.div>
              ...
              {/* Card */}
              <motion.div
                className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 shadow-[0_8px_40px_rgba(99,102,241,0.15)]"
              >
                <div className="relative">
                  ...
                  {index < steps.length - 1 && (
                    <motion.div 
                      className="absolute -right-12 top-1/2 -translate-y-1/2 text-violet-500 text-3xl opacity-40"
                      animate={{ x: [0, 10, 0] }}
